// When we have seen how to store single pieces of data in variables
// But when we have a lot of data that will be a lot of ungainly repeated code 
// it's better to use java array to store it as a list
// Array hold all of java data types : primitives (double, int, boolean) and also object referrences (String...)
